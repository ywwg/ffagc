...
class ActiveSupport::TestCase
  ...
  def sign_in_artist(user, password)
    post artists_login_path(session: {email: user.email.upcase, password: password})
  ...
  def sign_in_voter(user, password)
    post voters_login_path(session: {email: user.email.upcase, password: password})
  ...
  def sign_in_admin(user, password)
    post admins_login_path(session: {email: user.email.upcase, password: password})
